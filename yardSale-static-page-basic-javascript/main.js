...
const mainContainer = document.querySelector('.darken');
...
darken.addEventListener('click', cerrarTodasApretandoBody);
productDetailCloseIcon.addEventListener('click', closeProductDetailAside);

function toggleDesktopMenu() {
    const isshoppingCartContainerClosed = shoppingCartContainer.classList.contains('inactive');
    const isProductDetailClosed = productDetailContainer.classList.contains('inactive')
    const isDarkenOff = darken.classList.contains('inactive')
...
function cerrarTodasApretandoBody() {
    ...
    const isshoppingCartContainerClosed = shoppingCartContainer.classList.contains('inactive');
    const isProductDetailClosed = productDetailContainer.classList.contains('inactive');
    const isDarkenOff = productDetailContainer.classList.contains('inactive');



    if (!isMobileMenuClosed || !isDesktopClosed || !isshoppingCartContainerClosed || !isProductDetailClosed || !isDarkenOff) {
        desktopMenu.classList.add('inactive');
        mobileMenu.classList.add('inactive');
        shoppingCartContainer.classList.add('inactive');
        productDetailContainer.classList.add('inactive');
...
function openProductDetailAside() {
    ...
    const isMenuOpen = !productDetailContainer.classList.contains('inactive')
